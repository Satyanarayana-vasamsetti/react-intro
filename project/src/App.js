...
const App = () => {
  // const name = "Bunny"
  const apikey = "http://www.omdbapi.com?apikey=2e11921";
    ...
    <div className='container mt-4'>
      <div className='row movie-row'>
        ...
        <div className='text-center mt-4'>
          <button className='btn btn-primary' onClick={loadMoreMovies}>Load More Movies</button>
        </div>
      </div>
    </div>
      {/* <Navbar />
      ...
      {/* <UserDetails name="Narayana" email="narayana123@gmail.com" password="54321"/>
      <UserDetails name="sai" email="sai876@gmail.com" password="12345"/>
      <UserDetails name="bunny" email="bunny987@gmail.com" password="67890"/> */}
    </>
